...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| SC1-launch | TBD | TBD | BRAND-01/02, PLAT-01 | none | Branded window renders wordmark + sidebar (Bills/History/Settings), no logo | e2e | `npx playwright test e2e/launch.spec.ts` | ❌ W0 | ⬜ pending |
| SC1-theme | TBD | TBD | BRAND-01 | none | Window follows OS color scheme (light/dark class applied) | e2e + unit | `npx playwright test e2e/theme.spec.ts` | ❌ W0 | ⬜ pending |
...
| SC3-persist | TBD | TBD | PLAT-01 | none | Write app_settings, restart, read back same value | e2e (relaunch) | `npx playwright test e2e/persistence.spec.ts` | ❌ W0 | ⬜ pending |
