...
| 02-01-4 | 02-01 | 1 | ING-02 / D-01 | V4 | SettingsScreen "Change inbox folder" control invokes `window.api.ingestion.chooseInbox()` (dialog stubbed); displayed path becomes chosen path; cancel is a no-op | e2e | `npx playwright test e2e/inbox-picker.spec.ts` | ❌ W0 (task 02-01-4) | ⬜ pending |
