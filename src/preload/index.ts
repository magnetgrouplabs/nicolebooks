...
// ONLY named settings/secrets/theme methods. We never expose ipcRenderer or a generic
// invoke, so renderer code cannot reach an arbitrary channel. Each method is a thin invoke
// on a named channel constant; the payload is validated in the main handler (plan 01-05).

import { contextBridge, ipcRenderer, type IpcRendererEvent } from 'electron'
import { Channels, type Api as IpcApi } from '../shared/ipc-contract'
