...
describe('stubs reject with mapped copy, never a code or raw error text', () => {
  // Channels whose bodies have NOT landed yet. As each group lands, its rows move to the
  // landed list below and its real behaviour is covered by that group's own spec.
